...
Public Class Frm_cad_addCategorias
    Private Sub Frm_cad_addCategorias_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        TxtCategoria.Focus()
        TxtCategoria.Select()
    End Sub
    ...
    End Sub
    Private Sub Editar_Cad_Categoria()
        Try
            Abrir()
            Dim cmd As MySqlCommand
            Dim sqls As String

            sqls = "UPDATE tbl_cad_categorias SET categoria ='" & TxtCategoria.Text & "' , descricao = '" & TxtDescricao.Text & "' WHERE id = '" & TxtCod.Text & "'"
    ...
    Private Sub Salvar_Cad_Categoria()
        If TxtCategoria.Text <> "" Then
            ...
            Try
                ...
                sqls = "INSERT INTO tbl_cad_categorias (categoria, data_inclusao, descricao ) VALUES ('" & TxtCategoria.Text & "', '" & data & "', '" & TxtDescricao.Text & "')"
